namespace PushSharp.Apple
{
    ...
    public class ApnsConfiguration
    {
        ...
        private void Initialize(ApnsServerEnvironment serverEnvironment, X509Certificate2 certificate, bool validateIsApnsCertificate)
        {
        ...
        private void CheckIsApnsCertificate()
        {
            if (Certificate != null)
            {
